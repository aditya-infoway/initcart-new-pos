...
export const posPurchaseMaster: NavigationTree = {
  ...
  childs: [
    { id: "posPurchaseMaster.purchaseEntry",              type: "item", path: "/purchases",          title: "Purchase Entry",           icon: "posPurchaseMaster.purchaseEntry" },
    ...
    { id: "posPurchaseMaster.purchaseReturn",             type: "item", path: "/purchase-return",    title: "Purchase Return",          icon: "posPurchaseMaster.purchaseReturn" },
    { id: "posPurchaseMaster.createOrder",                type: "item", path: "/Addpurchaseitem",    title: "Create Order",             icon: "posPurchaseMaster.createOrder" },
    { id: "posPurchaseMaster.purchaseOrderVerify",        type: "item", path: "/purchaseReturnList", title: "Purchase Order Verify",    icon: "posPurchaseMaster.purchaseOrderVerify" },
