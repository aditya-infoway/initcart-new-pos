...
import {
  ...
  BanknotesIcon, BuildingOfficeIcon, CalendarDaysIcon,
...
export default function DayBookPage() {
  ...
  // ✅ CHANGED: accepts branchId and forwards it to ALL 4 API calls as
  ...
  const fetchAll = useCallback(async (branchId: string = selectedBranchId) => {
    ...
    try {
      ...
      const [cpRes, crRes, bpRes, brRes] = await Promise.all([
        Get("pos/cash-payments/",  params),
        Get("pos/cash-receipts/",  params),
