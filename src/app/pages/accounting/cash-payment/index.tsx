...
function AddCashPaymentDrawer({
  ...
  // ── Role detection ──────────────────────────────────────────────────
  // ✅ isSuperAdminOrEmployee - localStorage se role check
  ...
  const onSubmit = async (values: FormValues) => {
    ...
    try {
      ...
      // ── Stock Received ──────────────────────────────────────────────
        ...
        await Post("pos/pay-stock-received-bill-cash/", {
      ...
      // ── Stock Return Refund ─────────────────────────────────────────
        ...
        await Post("pos/pay-stock-return-bill-cash/", {
        ...
        <div className="px-(--margin-x) mt-2 grid grid-cols-2 gap-3 sm:grid-cols-5">
          ...
          {["CP","PCP","SRCP","STCP","STRCP"].map(t => {
            ...
            const bgMap: Record<string, string> = {
              ...
              STCP: "bg-gradient-to-br from-cyan-500 to-cyan-700",
              STRCP: "bg-gradient-to-br from-purple-500 to-purple-700",
            };
            return (
