  ...
  const onSubmit = async (values: FormValues) => {
    ...
    try {
      ...
      // ── Stock Transfer ──────────────────────────────────────────────
        ...
        await Post("pos/receive-stock-transfer-bill-bank/", {
      ...
      // ── B2B Sale ────────────────────────────────────────────────────
        ...
        await Post("pos/receive-b2b-sale-bill-bank/", {
      ...
      // ── Stock Return ─────────────────────────────────────────────────
        ...
        await Post("pos/receive-stock-return-bill-bank/", {
...
export default function BankReceiptPage() {
  ...
  const handleExport = () => {
    const headers = ["#","Date","Type","Voucher No","Bank Account","Party Name","Amount","Mode","Cheque No","Cheque Date","Clear Date","Narration","Created By"];
    ...
    <Page title="Bank Receipt Register">
      <div className="transition-content w-full pb-8">
        ...
        <div className="px-(--margin-x) mt-2 grid grid-cols-2 gap-3 sm:grid-cols-6">
          ...
          {["BR","SBR","PRBR","STBR","B2BSBR","STRBR"].map(t => {
            ...
            const bgMap: Record<string, string> = {
              ...
              STBR:   "bg-gradient-to-br from-cyan-500 to-cyan-700",
              B2BSBR: "bg-gradient-to-br from-indigo-500 to-indigo-700",
              STRBR:  "bg-gradient-to-br from-purple-500 to-purple-700",
            };
            return (
