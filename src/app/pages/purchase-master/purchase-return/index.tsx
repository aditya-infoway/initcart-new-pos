...
// ── Detail Modal ──────────────────────────────────────────────────────────
function DetailModal({ rec, onClose }: { rec: PurchaseReturn | null; onClose: () => void }) {
  return (
          ...
          <div className="flex min-h-full items-center justify-center p-4">
            ...
            >
              ...
              <div className="flex items-start justify-between bg-primary px-5 py-4">
                <div>
                  <h3 className="text-base font-bold text-white">Purchase Return Details</h3>
              ...
              <div className="grid grid-cols-2 gap-3 p-5 sm:grid-cols-4">
                {[
                  ...
                  { label: "Party",       value: rec?.partyName  ?? "" },
  ...
  const columns = useMemo<ColumnDef<PurchaseReturn>[]>(() => [
    ...
    },
    {
      ...
      cell: ({ getValue, table }: CellContext<PurchaseReturn, unknown>) => {
        ...
        return <span className="whitespace-nowrap font-medium text-primary-600 dark:text-primary-400 font-mono text-xs"><Highlight query={q}>{String(getValue() ?? "—")}</Highlight></span>;
      },
    },
    {
